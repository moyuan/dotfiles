...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias vi='vim'
    alias gccgen='gcc -W -Wall -ansi -pedantic'
    alias gccgdb='gcc -Wall -Wextra -ggdb3'
    alias g++gdb='g++ -Wall -std=c++11 -Wextra -ggdb3'
    alias g++boost='g++gdb -I /usr/local/boost_1_59_0'
fi
